...
template <typename T>
void add_data_scalar(T *dest_data, T *src1, T *src2, const int data_num)
{
  for (int i = 0; i < data_num; i++) {
...
void add_data_mask_scalar(int8_t *dest_data, int8_t *src1, int8_t *src2, int8_t *mask, const int data_num)
{
  for (int i = 0; i < data_num; i++) {
...
int test_8()
{
  ...
  add_data_vec_8 ((int8_t *)vec_data,    (int8_t *)source_data1, (int8_t *)source_data2, data_num);
  add_data_scalar((int8_t *)scalar_data, (int8_t *)source_data1, (int8_t *)source_data2, data_num);
...
int test_16()
{
  ...
  add_data_vec_16((int16_t *)vec_data,    (int16_t *)source_data1, (int16_t *)source_data2, data_num);
  add_data_scalar((int16_t *)scalar_data, (int16_t *)source_data1, (int16_t *)source_data2, data_num);
...
int test_32()
{
  ...
  add_data_vec_32((int32_t *)vec_data,    (int32_t *)source_data1, (int32_t *)source_data2, data_num);
  add_data_scalar((int32_t *)scalar_data, (int32_t *)source_data1, (int32_t *)source_data2, data_num);
...
int test_64()
{
  ...
  add_data_vec_64((int64_t *)vec_data,    (int64_t *)source_data1, (int64_t *)source_data2, data_num);
  add_data_scalar((int64_t *)scalar_data, (int64_t *)source_data1, (int64_t *)source_data2, data_num);
