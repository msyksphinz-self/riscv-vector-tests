...
int test_8()
{
  ...
  maxu_data_vec_8 ((uint8_t *)vec_data,    (uint8_t)source_data1[0], (uint8_t *)source_data2, data_num);
  maxu_data_scalar((uint8_t *)scalar_data, (uint8_t)source_data1[0], (uint8_t *)source_data2, data_num);
...
int test_16()
{
  ...
  maxu_data_vec_16((uint16_t *)vec_data,    (uint16_t)source_data1[0], (uint16_t *)source_data2, data_num);
  maxu_data_scalar((uint16_t *)scalar_data, (uint16_t)source_data1[0], (uint16_t *)source_data2, data_num);
...
int test_32()
{
  ...
  maxu_data_vec_32((uint32_t *)vec_data,    (uint32_t)source_data1[0], (uint32_t *)source_data2, data_num);
  maxu_data_scalar((uint32_t *)scalar_data, (uint32_t)source_data1[0], (uint32_t *)source_data2, data_num);
...
int test_64()
{
  ...
  maxu_data_vec_64((uint64_t *)vec_data,    (uint64_t)source_data1[0], (uint64_t *)source_data2, data_num);
  maxu_data_scalar((uint64_t *)scalar_data, (uint64_t)source_data1[0], (uint64_t *)source_data2, data_num);
