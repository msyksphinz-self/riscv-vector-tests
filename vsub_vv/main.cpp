...
int test_8()
{
  ...
  sub_data_vec_8 ((int8_t *)vec_data,    (int8_t *)source_data1, (int8_t *)source_data2, data_num);
  sub_data_scalar((int8_t *)scalar_data, (int8_t *)source_data1, (int8_t *)source_data2, data_num);
...
int test_16()
{
  ...
  sub_data_vec_16((int16_t *)vec_data,    (int16_t *)source_data1, (int16_t *)source_data2, data_num);
  sub_data_scalar((int16_t *)scalar_data, (int16_t *)source_data1, (int16_t *)source_data2, data_num);
...
int test_32()
{
  ...
  sub_data_vec_32((int32_t *)vec_data,    (int32_t *)source_data1, (int32_t *)source_data2, data_num);
  sub_data_scalar((int32_t *)scalar_data, (int32_t *)source_data1, (int32_t *)source_data2, data_num);
...
int test_64()
{
  ...
  sub_data_vec_64((int64_t *)vec_data,    (int64_t *)source_data1, (int64_t *)source_data2, data_num);
  sub_data_scalar((int64_t *)scalar_data, (int64_t *)source_data1, (int64_t *)source_data2, data_num);
